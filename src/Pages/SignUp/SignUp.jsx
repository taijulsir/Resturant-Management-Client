                                            ...
                                            <div className="space-y-6">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="relative flex items-center">
                                                        <input {...register("name", { required: true })} name="name" type="text" className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter name" />
                                                ...
                                                <div>
                                                    ...
                                                    <div className="relative flex items-center">
                                                        <input {...register("email", { required: true })} name="email" type="email" className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter email" />
                                                    ...
                                                    {errors.email && <span className="text-red-500 font-medium">This filed is required</span>}
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="relative flex items-center">
                                                        <input {...register("photoUrl", { required: true })} name="photoUrl" type="url" className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter photo url" />
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-4 h-4 absolute right-4" viewBox="0 0 682.667 682.667">
                                                            <defs>
                                                                <clipPath id="a" clipPathUnits="userSpaceOnUse">
                                                                    <path d="M0 512h512V0H0Z" data-original="#000000"></path>
                                                    ...
                                                    <div className="relative flex items-center">
                                                        <input
                                                            {...register("password",
                                                                ...
                                                                })} name="password" type="password" className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter password" />
